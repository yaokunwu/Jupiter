...
public class Item {
	...
	public static void main() {
		// new Item.ItemBuilder() is a whole
		Item item = new Item.ItemBuilder().setAddress("abc").setName("1234").build();
		ItemBuilder itembd1 = new Item.ItemBuilder().setAddress("abc").setName("1234");
		ItemBuilder itembd2 = new Item.ItemBuilder().setAddress("cde").setName("5678");
		System.out.println(itembd1.address);
		System.out.println(itembd2.address);
	}
